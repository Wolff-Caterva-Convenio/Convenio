# ====================================
# CONVENIO CANCEL TEST (>72H BAND)
# Policy:
#   - Refund ratio: 0.95
#   - Kept amount = 5% of total paid
#   - Platform keeps all kept amount
#   - Host payout = 0
...
Write-Host "===================================="
Write-Host "CONVENIO CANCEL TEST (>72H BAND)"
Write-Host "===================================="
Write-Host ""
...
# CREATE BOOKING (>72h away)
$checkIn  = (Get-Date).AddMonths(6).AddDays((Get-Random -Minimum 1 -Maximum 20)).ToString("yyyy-MM-dd")
...
$expectedRefund = Round-Int($total * 0.95)

if ($actualRefund -ne $expectedRefund) {
    throw "Refund mismatch. Expected $expectedRefund, got $actualRefund"
}

$keptAmount = [int]$total - $actualRefund
if ($keptAmount -lt 0) { $keptAmount = 0 }

# >72h policy: platform keeps ALL kept amount, host gets 0
$platformKeep = $keptAmount
$hostPayout = 0
...
Write-Host ""
Write-Host "===================================="
Write-Host "CANCEL TEST PASSED (>72H, 95%)"
Write-Host "===================================="