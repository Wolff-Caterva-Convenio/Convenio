    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/venues/${venue_id}`, {
        ...
        body: JSON.stringify({
          ...
          payout_net_per_night: Math.round(Number(priceEur || 0) * 100),
          minimum_nights: Number(minNights || 1),
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 12, fontSize: 14, color: "#666" }}>
          Unpublish is connected. Publish, rules, price, and minimum nights are
          not wired to active backend routes in the current project state yet.
        </div>
        <button
